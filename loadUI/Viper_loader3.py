from PySide6.QtWidgets import (
    ...
    QLabel, QGraphicsView, QGraphicsScene, QGraphicsProxyWidget,QTabWidget
    )
...
from for3d import AnimatedListView
...
class LoadUI(QMainWindow):
    def __init__(self, username):
        ...
        """ 🔹 AnimatedListView 초기화 (populate_table 호출 전에 생성) """
        # ✅ 기존 `tableWidget`을 AnimatedListView에 적용
        self.list_animated_view = AnimatedListView(self.ui.tabWidget)  # ✅ tabWidget 사용
